...
|名前|合計数|備考|
|:-|:-|:-|
|※メイン基板|2枚|一層基板です。左右キーボード用で各1枚です。|
|トッププレート|2枚|PCB製です。左右共通です。|
|ボトムプレート|2枚|アクリル製です。左右共通です。|
|ProMicroカバー|2枚|アクリル製です。左右共通です。|
|ダイオード|46個|SMDタイプです。|
|ピンヘッダ1x8|2個|拡張基板未使用時は余ります。|
|ピンソケット1x4 |2個||
|ピンソケット1x12|4個||
|ピンヘッダ1x12|4個|ProMicroの袋の中に同梱されています。|
|※ピンヘッダ1x4|2個|OLED用に付属しています。OLEDにはんだ付け済みの場合は付属しません。|
|細ピンヘッダ1x3|4個||
|ジャンパピン|4個|色はロットによって変わる場合があります。|
|リセットスイッチ|2個|色はロットによって変わる場合があります。|
|TRRSジャック|2個||
|OLED|2個||
|ProMicro|2個|
|※LEDテープ|2個|1つにつきLED5個付属しています。|
|M2x7mmスペーサー|8個||
|M2x12mmスペーサー |4個||
|M2x4mmねじ|20本||
|M2x8mmねじ|4本|M2x12mmスペーサー固定用です。|
|ゴム足|8個||
...
|ダイオード|20個|SMDタイプです。|
|ピンヘッダ1x8|2個||
|ジャンパピン|16個|色はロットによって変わる場合があります。|
|ゴム足|8個||
...
* (オプション。ただしVer1.03以降の基板のみ対応)トラックボールADTB7M及びトラックボールモジュール用レベル変換基板
