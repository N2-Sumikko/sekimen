...
I2C通信時の取付け方法を示す画像は後程追加予定です。(あまり需要はないと思っています…。)
...
最初から拡張基板を使用する場合は、キーキャップは拡張基板組立後に取付けるとよいです。
...
写真のように、拡張基板へダイオード10個(両手分でで20個)をはんだ付けします。手順はメイン基板と同じです。
...
写真のようにピンヘッダ1x8を基板に取付けます。(短いほうが基板側です。)
...
まずは写真のようにベース基板へピンヘッダ1x8を取付けます。(細い方が基板側です。)
...
ボトムプレート側のM2x4mmねじ4本を緩め、ベース基板からボトムプレートを取外します。
...
写真のようにボトムプレート2枚をM2x7mmスペーサーへM2x4㎜ねじ6本で仮止め(部品が脱落しない程度の強さでねじ止め)します。
...
仮止め後、写真のようにボトムプレートへゴム足8つを取付けます。
