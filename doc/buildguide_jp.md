...
トラックボールを使用する場合、画像の位置に左キーボードの基板にロープロファイル1x4ピンソケットを取付け、はんだ付けします。
<img width="600" alt="ロープロファイルピンソケット1x4取付後_表面" src="https://user-images.githubusercontent.com/54104281/99962405-76d5bb00-2dd3-11eb-95d7-925ab93008a5.png">
