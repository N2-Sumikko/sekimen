...
* (オプション。ただしVer1.03の基板のみ対応)トラックボールADTB7M及びトラックボールモジュール用レベル変換基板
...
# メイン基板の組立て
本ビルドガイドの画像は右キーボード用のものですが、左キーボードの組立てもほぼ同じです。(部品の位置が若干異なるくらいです。)
...
画像のように、トッププレートへ長さ12mmのスペーサー2つをM2x8mmのねじ2本でそれぞれ固定します。左キーボードの場合、トッププレートの向きは左右逆です。

ただし、トラックボールを使用する場合は、取り付けるスペーサの長さが異なります。詳しくはこちらをご参考ください。(リンク準備中です。)

ねじの長さは8mmなので注意してください。また、スペーサーを組立後に取付けるのは難しいので、忘れずに取り付けてください。
