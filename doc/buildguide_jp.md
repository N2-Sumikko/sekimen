...
※もしすべてのピンをはんだ付けした後にピンソケットの位置が悪いことに気づいてしまった場合は、とりあえず先の手順に進んでみてください。
...
位置決めがどうしても難しい場合は、ピンソケットの樹脂部分(端子ではありません)と基板を接着剤等で接着するのもよいかと思います。
...
<img width="600" alt="リセットスイッチはんだ付け後" src="https://user-images.githubusercontent.com/54104281/87410839-c6c09c00-c601-11ea-9e72-38527e9f8cb7.png">
...
ファームウェアの書込み及びダイオードの動作テストはここ行うのがおすすめです。(もし問題が起きた時に、キースイッチが原因かそれ以外かを切り分けしやすいので)
手順は〇〇を参考にしてください。

# トッププレートへのスペーサーの取り付け

# トッププレート四隅へのキースイッチ取付け
