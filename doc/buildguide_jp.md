...
* リード部品の破片等(拡張基板使用時のキーボードの強度を上げたい場合、メイン基板と拡張基板のトッププレート間のはんだ付けに使用します。) 
...
メイン基板と拡張基板の位置があっていない場合は微調整します。(ボトムプレートが仮止め状態であれば、若干の位置調整が可能です。)
