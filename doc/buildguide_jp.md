...
|(オプション)Sekimen 拡張キット|1個|キーの数を増やす場合に使用します。|
|(オプション)Sekimen トラックボール取付キット|1個|トラックボールモジュールADTB7Mを取付ける場合に使用します。使用時の必要部品は[こちら](https://github.com/N2-Sumikko/sekimen/blob/master/doc/trackball_jp.md)をご確認ください。|
|(トラックボール取付キット使用時)トラックボールモジュールADTB7M|1個|ビット・トレード・ワン様のトラックボールモジュール(型番：ADTB7M)です。|
|(トラックボール取付キット使用時)トラックボールモジュール用レベル変換基板|1個|のぎけす屋様のトラックボールモジュール用レベル変換基板です。|
