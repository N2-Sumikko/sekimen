...
|※ピンヘッダ1x4|1個|OLED用に付属しています。OLEDにはんだ付け済みの場合は付属しません。|
|細ピンヘッダ1x3|2個||
...
|M2x12mmスペーサー |2個||
|M2x4mmねじ|10本||
|M2x10mmねじ|2本|M2x12mmスペーサー固定用です。|
|ゴム足|4個||
...
* はんだ付けに自信が無い場合は、はんだ付けする箇所にはフラックスを薄く塗布してからはんだ付けしてください。(特にLEDテープのはんだ付け)
...
# (オプション)ロープロファイルピンソケット1x4の取付(ver1.03以降)

ver1.03以降のバージョンでは、左キーボードのOLEDの左のキーの代わりに、ビット・トレード・ワンのトラックボールADTB7Mの取付が可能です。

トラックボールを使用する場合、画像のように左キーボードの基板にロープロファイル1x4ピンソケットをはんだ付けします。
...
画像のように、トッププレートへ長さ12mmのスペーサー2つをM2x10mmのねじ2本でそれぞれ固定します。

ただし、トラックボールを使用する場合は、こちら(リンク作成予定です。)の手順に従い別の長さの

ねじの長さは10mmなので注意してください。また、スペーサーを組立後に取付けるのは難しいので、忘れずに取り付けてください。
...
キースイッチの四隅に羽根があるものは、羽根の部分がピンヘッダ1x8と干渉する場合があります。
