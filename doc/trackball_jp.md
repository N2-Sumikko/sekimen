...
* トラックボールモジュール用レベル変換基板にピンヘッダ1x4をはんだ付けする際は、端子の位置にご注意ください。(変換基板のNC端子は使用しません。)
...
画像の様に、M2x10mmのねじ2本にM2x4mmスペーサーをそれぞれ取付けます。取付時のトルクは、スペーサーを回転させたときにねじが回らない位の強さならnOKです。
...
　少し後になるかと思いますが、このページにdefaultのキーマップをベースにしたファームウェアの整備方法を記載する予定ですので、今しばらくお待ちいただけると幸いです。）
