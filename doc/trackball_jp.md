...
　(メイン基板の組立後にロープロファイルピンソケット1x4を取付ける場合、トッププレートの一部を削れば取付けられると思いますが、きっと大変です。私はまだやったことが無いですが、今度一回やってみます。）
...
M2x10mmのねじ2本にM2x4mmスペーサーをそれぞれ取付けます。スペーサーを回転させたときにねじが回らない状態になれば大丈夫です。
...
画像のように、変換基板へはんだ付けしたピンヘッダ1x4をロープロファイルピンソケット1x4へ取付けます。
